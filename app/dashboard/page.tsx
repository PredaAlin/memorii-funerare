...
export default async function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="mb-10">
        <h1 className="text-4xl font-bold serif text-stone-800 mb-2">My Memorials</h1>
        <p className="text-stone-500">Manage your memorial pages and track your orders.</p>
      </div>

      {orders.length === 0 ? (
        <div className="text-center py-24 border-2 border-dashed border-stone-200 rounded-3xl bg-white">
          <p className="text-stone-500 mb-6">You haven&apos;t ordered any memorials yet.</p>
              ...
              <div className="p-6 flex flex-col md:flex-row gap-6 items-start">
                  ...
                  {order.memorial.isPublished ? (
                    ...
                    <div className="w-32 h-32 bg-stone-100 rounded-2xl flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-[8px] text-stone-400 font-bold uppercase">Pending</p>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="flex-grow">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h2 className="text-xl font-bold serif text-stone-800">{order.memorial.deceasedName || 'Untitled Memorial'}</h2>
